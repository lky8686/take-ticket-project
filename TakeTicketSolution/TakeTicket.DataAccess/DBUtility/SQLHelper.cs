...
namespace TakeTicket.DataAccess.DBUtility
{
    /// <summary>
    /// SQLHelper 数据逻辑访问帮助类
    /// update 2004-10-07
    ...
    {
        public static readonly string CONNECTION_STRING = SiteConfigManager.Intance.DatabaseSettings["TakeTicket"].ConnectionString;
